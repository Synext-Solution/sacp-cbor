...
fn abi_schema_errors_fail_to_compile() {
    ...
    t.compile_fail("tests/ui/zero_field_id.rs");
    ...
    t.compile_fail("tests/ui/zero_variant_id.rs");
    ...
    t.compile_fail("tests/ui/string_wire_override.rs");
    t.compile_fail("tests/ui/iterator_is_not_exact_sequence.rs");
